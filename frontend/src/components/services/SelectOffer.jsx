                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                        {timeRanges.map((range) => (
                            <div
                                key={range.value}
                                className={`flex justify-between items-center px-4 py-3 rounded-3xl text-lg md:text-xl cursor-pointer ${selectedTimeRange === range.value
                            ...
                            >
                                <div className="flex items-center">
                                    <div
                                        className={`w-5 h-5 rounded-full border-2 flex items-center justify-center mr-2 ${selectedTimeRange === range.value
