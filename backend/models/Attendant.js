...
const attendantSchema = new mongoose.Schema({
  ...
  professionalInfo: {
    ...
    previousEmployment: {
      ...
      companyDuration: { type: String, default: '' },
      referenceContact: { type: String, default: '' }
    }
  },

  // Skills Section (Separated from professionalInfo)
  skillsInfo: {
    skills: [{ type: String }],
    certifications: [{
      _id: false,
      name: { type: String, default: 'Untitled Certificate' },
      authority: { type: String, default: 'Unknown Authority' },
